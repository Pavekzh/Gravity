...
public class GenericModulePresenter : IModulePresenter
{
    private RectTransform root;
    private RectTransform label;
    private RectTransform propertiesContainer;

    public GenericModulePresenter(RectTransform Root,RectTransform Label, RectTransform PropertiesContainer)
    {
        this.root = Root;
        this.label = Label;
